...
/**
 *
 * Clone a service configuration by config number. Config number defaults to the number of the "active" configuration.
 *
 * @param serviceId
...
/**
 *
 * Get the currently active VCL for a service.
 *
 * @param {string} serviceId
 * @param {string} [configVersionNumber] - If no config version number is passed, defaults to active config version.
 */
FastlyPromise.prototype.getActiveVcl = function getActiveVcl(serviceId, configVersionNumber) {
  var self = this;
